            ...
            <div>
                <form id="fregister" name="fregister" method="POST" enctype="multipart/form-data" action="SignUp.php">
                    <table class="table_fregister">
                        ...
                        <tr><td>Dirección de correo<sup>*</sup> <input type="email" size="75" id="dirCorreo" name="dirCorreo" onblur='verifyClient()'></td></tr>
                        <tr><td><span id='verify'></span></td></tr>
                        <tr><td>Nombre y apellido(s)<sup>*</sup> <input type="text" size="75" id="nAp" name="nAp" ></td></tr>
                        <tr><td>Contraseña (long>5)<sup>*</sup> <input type="password" size="75" id="pass1" name="pass1" onblur='verifyPass()'></td></tr>
